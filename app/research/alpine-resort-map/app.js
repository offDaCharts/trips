...
const hotels = [
  ...
  },
  {
    ...
    images: [
      { src: "moargut-exterior.jpg", alt: "Moar Gut resort, gardens and outdoor pool in the Grossarl valley", caption: "The resort at dusk" },
      { src: "moargut-suite.jpg", alt: "Suite Vergissmeinnicht adult sleeping and living area", caption: "Suite Vergissmeinnicht" },
      { src: "moargut-baby-care.jpg", alt: "Separate infant nap room at the Moar Gut Kinderhof", caption: "Dedicated baby nap room" },
      { src: "moargut-farm.jpg", alt: "Cows walking through the Moar Gut organic farm", caption: "Working organic farm" },
      { src: "moargut-spa.jpg", alt: "Moar Gut spa and wellness area", caption: "Wellness and spa" },
      { src: "moargut-lake.jpg", alt: "Natural swimming lake and loungers at Moar Gut", caption: "Natural swimming lake" },
      { src: "moargut-riding.jpg", alt: "Horse riders crossing an alpine meadow near Moar Gut", caption: "Mountain riding" },
      { src: "moargut-dining.jpg", alt: "Breakfast table at Moar Gut", caption: "Gourmet full board" },
    ...
    deepDive: "./moargut/",
    sources: [
      { label: "Official resort overview", url: "https://www.moargut.com/en/" },
      { label: "Suite Vergissmeinnicht", url: "https://www.moargut.com/suiten/suite-vergissmeinnicht/" },
      { label: "Gourmet full board", url: "https://www.moargut.com/en/cuisine/gourmet-full-board/" },
